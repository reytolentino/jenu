...
class MD_Partialpayment_Block_Adminhtml_Summary_View extends Mage_Adminhtml_Block_Widget
{
    ...
    public function getTitle()
    {
        ...
        return Mage::helper('sales')->__('Order # %s %s | %s', $this->getPayment()->getOrder()->getRealOrderId(), $_extOrderId, $this->formatDate($this->getPayment()->getOrder()->getCreatedAtDate(), 'medium', true));
    }
