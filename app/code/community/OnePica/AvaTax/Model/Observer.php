...
class OnePica_AvaTax_Model_Observer extends Mage_Core_Model_Abstract
{
    ...
    public function adminSystemConfigChangedSectionTax($schedule) {
        ...
        if(!Mage::getResourceModel('cron/schedule_collection')->count()) {
            $warnings[] = 'It appears that Magento\'s cron scheduler is not running. For more information, see <a href="http://www.magentocommerce.com/wiki/how_to_setup_a_cron_job" target="_black">How to Set Up a Cron Job</a>.';
        }
