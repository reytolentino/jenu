...
class Web2Market_Report_Block_Adminhtml_Report
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * This is your module alias
     */
    protected $_blockGroup      = 'queryreport';
    /**
    ...
    /*
        ...
        So the complete block would called queryreport/adminhtml_report_grid . As you already guessed it,
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('queryreport')->__('My Custom Reports');
        // Set hard-coded template. As you can see, the layout.xml 
        // attribute is ineffective, but we keep up with conventions
        //$this->setTemplate('queryreport/grid/container.phtml');
        ...
        $this->addButton('filter_form_submit', array(
            'label'     => Mage::helper('queryreport')->__('Show Report'),
