...
class AW_Raf_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const REFERRAL_RECOGNIZE_TYPE  = 'awraf/referral/recognize_by';
    ...
    public function referralRecognizeType($store = null)
    {
        return (int) Mage::getStoreConfig(self::REFERRAL_RECOGNIZE_TYPE, $store);
    }
