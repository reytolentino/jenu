...
class AW_Raf_Model_Source_RuleType
{
    ...
    {
        $options = array(
            self::SIGNUP_VALUE         => Mage::helper('awraf')->__(self::SIGNUP_LABEL),
            self::ORDER_AMOUNT_VALUE   => Mage::helper('awraf')->__(self::ORDER_AMOUNT_LABEL),
            self::ORDER_ITEM_QTY_VALUE => Mage::helper('awraf')->__(self::ORDER_ITEM_QTY_LABEL)
        );
