    ...
    public function setPrice($price)
    {
        if ($this->getIsPromo()
            ...
            if (!$this->getRule()->getAmpromoUseDiscountAmount()) {
                if ($this->getProductType() == 'simple' && array_key_exists('parent_item', $this->_data['product']->_data['stock_item']->_data)) {
                    $price = $this->_data['product']->_data['stock_item']->_data['parent_item']->_data['price'];
                }
                $price              = $this->_getDiscountPrice($price);
            }
