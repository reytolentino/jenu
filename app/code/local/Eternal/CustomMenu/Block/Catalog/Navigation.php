...
class Eternal_CustomMenu_Block_Catalog_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawCustomMenuBlock()
    {
        ...
        $html[] = '<div id="menu' . $blockId . '" class="menu" onmouseover="eternalShowMenuPopup(this, event, \'popup' . $blockId . '\');" onmouseout="eternalHideMenuPopup(this, event, \'popup' . $blockId . '\', \'menu' . $blockId . '\')">';
        $html[] = '<div class="parentMenu">';
