...
class Eternal_Zonda_Block_Adminhtml_System_Config_Form_Field_Texture extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Add texture preview
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $texUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . Mage::helper('zonda')->getTexturePath();
