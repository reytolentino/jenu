...
abstract class Smartwave_Blog_Block_Abstract extends Mage_Core_Block_Template
{
    ...
    {        
        ...
        foreach ($collection as $item) {
            ...
            if ($shortContent) {
                ...
                $strManager = new Smartwave_Blog_Helper_Substring(array('input' => self::$_helper->filterWYS($item->getPostContent())));
    ...
    {      
        return '<a class="smartwave-blog-read-more button" href="'.$item->getAddress().'">'.$this->__('Read More').'</a>';
    }
